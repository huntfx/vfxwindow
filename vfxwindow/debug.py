...
class TestWindow(VFXWindow):
    ...
    def __init__(self, **kwargs):
        ...
        if self.application == 'Maya':
            ...
            self.callbacks.add('attribute.rename', lambda msg, plug, otherPlug, clientData: print('Callback: attribute.rename ({}, {}, {})'.format(msg, plug, otherPlug)), om2.MObject.kNullObj)
